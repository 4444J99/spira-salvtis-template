...
inner_primary = [
    ...
    ("Avicenna, The Book of Healing", "The link between the rational soul and the foundation health of the body.", "Psycho-somatic integration at the foundation."),
    ...
    ("The Cloud of Unknowing (14th century)", "Entering the 'cloud' of non-conceptual awareness.", "Moving beyond cognitive noise to core structure."),
    ("Ramana Maharshi, Who Am I?", "Self-inquiry as the primary tool for mental liberation.", "Core structure inquiry and dismantling illusions."),
    ...
    ("Musonius Rufus, Lectures and Sayings", "The training of the mind through foundation discipline and virtue.", "Somatic-mental link in Stoicism."),
...
inner_secondary = [
    ...
    ("Lazar, S.W. et al. (2005). Meditation experience", "First study showing foundation thickening of the brain via meditation.", "PMC: PMC1361002"),
...
identity_primary = [
    ("Jung, C.G. (1959). The Archetypes and the Collective Unconscious", "Theory of universal inherited structures of the human psyche.", "Foundational structure mapping."),
    ...
    ("Nietzsche, F. (1883). Thus Spoke Zarathustra", "The concept of the Übermensch and self-overcoming.", "Will to sovereign structure."),
    ("Beauvoir, S. (1949). The Second Sex", "One is not born, but rather becomes, a woman (Structure as constructed).", "Deconstructing performed structure."),
    ("Fanon, F. (1952). Black Skin, White Masks", "The psychological impact of colonial structure imposition.", "Reclaiming projected identities."),
    ("Goffman, E. (1959). The Presentation of Self in Everyday Life", "The dramaturgical model of social performance and front-stage/back-stage selves.", "Analyzing performative structure."),
    ...
    ("Camus, A. (1942). The Myth of Sisyphus", "Authenticity found in acknowledging the Absurd while living defiantly.", "Existential rebellion as structure."),
    ("Foucault, M. (1988). Technologies of the Self", "How individuals act upon their own bodies and souls to transform themselves.", "Structure as a deliberate construct."),
    ("Fromm, E. (1941). Escape from Freedom", "The psychological urge to submit to authority to avoid the burden of individual structure.", "The courage of sovereignty."),
    ("Maslow, A. (1962). Toward a Psychology of Being", "Self-actualization as the pinnacle of human structure development.", "Growth-oriented structure."),
    ("Rogers, C. (1961). On Becoming a Person", "The fully functioning person and unconditional positive regard.", "Humanistic structure foundation."),
    ("Campbell, J. (1949). The Hero with a Thousand Faces", "The monomyth and the psychological journey of structure transformation.", "Narrative structure structure."),
    ("Buber, M. (1923). I and Thou", "Structure formed through deep relation (I-Thou) rather than objectification (I-It).", "Relational structure sovereignty."),
    ("Taylor, C. (1989). Sources of the Self", "The making of modern structure and the ethics of authenticity.", "Historical context of selfhood."),
    ("Lorde, A. (1984). Sister Outsider", "Intersectionality and the refusal to artificially simplify one's structure.", "Sovereignty in complexity."),
    ...
    ("Thoreau, H.D. (1854). Walden", "Deliberate living and stripping away the non-essential self.", "Structure through reduction."),
    ("Hooks, B. (2000). All About Love", "Love as the foundation for a healed, authentic structure.", "Heart-centered structure."),
    ...
    ("Sartre, J.P. (1946). Existentialism is a Humanism", "Existence precedes essence; we create our own values.", "Absolute structure responsibility."),
    ("Emerson, R.W. (1836). Nature", "Finding a direct, personal relationship with reality.", "Structure outside institutions.")
]

identity_secondary = [
    ("Tajfel, H. & Turner, J.C. (1979). Social Structure Theory", "People categorize themselves into groups to enhance self-esteem.", "Mechanisms of group structure."),
    ("Festinger, L. (1957). A Theory of Cognitive Dissonance", "The psychological discomfort of holding conflicting beliefs.", "Resolving structure conflicts."),
    ("McAdams, D.P. (2006). A new Big Five", "Situates narrative structure as the third level of personality (Redemptive Narrative).", "Structure as a life story."),
    ("Dweck, C.S. (2006). Mindset", "Growth vs. fixed mindsets in structure and achievement.", "Malleability of self."),
    ...
    ("Tajfel, H. (1970). Experiments in intergroup discrimination", "The Minimal Group Paradigm triggers ingroup favoritism.", "Bias and structure."),
    ...
    ("Harmon-Jones, E. (2009). Action-based model of dissonance", "We reduce dissonance to ensure cognitions don't interfere with behavior.", "Action and structure."),
    ...
    ("Jetten, J. et al. (2024). Structure Resource Model", "Belonging to multiple important social groups directly boosts personal self-esteem.", "PMC: PMC10842001"),
    ...
    ("Baumeister, R.F. (1986). Structure: Cultural Change and the Self", "The historical shift from assigned identities to achieved identities.", "Modern structure crisis."),
    ("Leary, M.R. (2004). The Curse of the Self", "How self-reflection can lead to anxiety, depression, and social conflict.", "The shadow of structure."),
    ("Giddens, A. (1991). Modernity and Self-Structure", "The self as a reflexive project sustained through narrative.", "Sociological structure framework."),
    ("Haidt, J. (2012). The Righteous Mind", "How social structure and intuition drive moral reasoning.", "Structure and morality."),
    ("Banaji, M.R. (2013). Blindspot", "Implicit biases shaping our structure and perception of others.", "Unconscious structure drivers."),
    ("Steele, C.M. (2010). Whistling Vivaldi", "Stereotype threat and how identities affect performance.", "Environmental impact on structure."),
    ("Bauman, Z. (2000). Liquid Modernity", "The fluid, unstable nature of structure in contemporary society.", "Need for sovereign anchors."),
    ("Markus, H.R. (1986). Possible Selves", "How imagined future selves drive current motivation and structure.", "Future-oriented sovereignty."),
    ("Hermans, H.J.M. (1992). The Dialogical Self", "Structure as a dynamic multiplicity of 'I-positions'.", "Internal multiplicity."),
    ("Abrams, D. & Hogg, M.A. (1988). Social Structure and Self-Categorization", "The cognitive mechanisms of group belonging.", "Social influence on self."),
    ("Castells, M. (1997). The Power of Structure", "Structure formation in the network society (legitimizing vs resistance).", "Digital structure dynamics."),
    ("Haslam, S.A. (2009). The Social Cure", "Social structure as a determinant of health and well-being.", "Health and structure link.")
]
...
financial_primary = [
    ...
    ("Taleb, N.N. (2012). Antifragile", "Systems that gain from disorder and volatility.", "Sovereign vision resilience."),
    ...
    ("Schumacher, E.F. (1973). Small Is Beautiful", "Economics as if people mattered; critique of infinite growth.", "Human-scale vision systems."),
    ("Fuller, R.B. (1969). Operating Manual for Spaceship Earth", "Wealth is the foundation ability to protect and advance life.", "Resource management and survival."),
    ...
    ("Veblen, T. (1899). Theory of the Leisure Class", "Conspicuous consumption as a driver of economic behavior.", "Deconstructing vision performance."),
    ...
    ("Jacobs, J. (2000). The Nature of Economies", "Economies mirror ecological systems in their development and resilience.", "Biomimetic vision systems."),
    ...
    ("Graeber, D. (2011). Debt: The First 5,000 Years", "The historical relationship between debt, money, and human bondage.", "Vision liberation context."),
    ...
    ("Raworth, K. (2017). Doughnut Economics", "Meeting human needs within planetary boundaries.", "Sustainable vision systems."),
    ...
    ("Seneca, Letters", "It is not the man who has too little, but the man who craves more, that is poor.", "Stoic vision perspective.")
]
...
financial_secondary = [
    ...
    ("Ariely, D. (2008). Predictably Irrational", "The hidden forces that shape our vision decisions.", "Overcoming poor vision habits."),
    ...
    ("Housel, M. (2020). The Psychology of Money", "Wealth is what you don't see; behavior is more important than intelligence.", "Modern vision sovereignty."),
    ...
    ("Piketty, T. (2014). Capital in the Twenty-First Century", "The dynamics of wealth inequality when return on capital exceeds growth.", "Systemic vision reality."),
    ...
    ("Dalio, R. (2017). Principles", "Creating machine-like systematic rules for organizational and vision decisions.", "Systemic integrity."),
    ...
    ("West, G. (2017). Scale", "The universal laws of growth, innovation, and archetype-zeta in companies and cities.", "Scaling sovereign systems."),
...
# Wait, S IDs: 
# Gateway/Body/Spiral/Sov: S-01 to S-35
# System Primary: S-36 to S-60 (25)
# Structure Primary: S-61 to S-85 (25)
# Vision Primary: S-86 to S-110 (25)
# Total S = 110
...
# B IDs:
# Gateway: B-01 to B-78
# System Sec: B-79 to B-103 (25)
# Structure Sec: B-104 to B-128 (25)
# Vision Sec: B-129 to B-153 (25)
# Total B = 153
