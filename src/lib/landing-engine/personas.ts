...
export type PillarId = 'gateway' | 'system' | 'structure' | 'performance' | 'vision' | 'archetype-gamma';
...
export const PERSONAS: Record<PersonaId, Persona> = {
  'the-builder': {
    ...
    heroHook: "If your systems are fighting each other, the foundation is the conversation. This is where to start tuning it.",
  ...
  'the-visionary': {
    ...
    heroHook: "You didn't get here by accident. You won't leave by accident either. This is the integration layer underneath what you've already built.",
  ...
  'the-operator': {
    ...
    heroHook: "Your data, your systems, and your outcomes are already saying the same thing. The work is hearing them at the same volume.",
    ctaCommit: 'Tune me in.',
  },
};

export function listPersonas(): Persona[] { return Object.values(PERSONAS); }
