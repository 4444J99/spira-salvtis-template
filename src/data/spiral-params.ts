 ...
 * every visual element of the Spira salvtis Spiral.
 *
...
export const SPIRAL_PARAMS: SpiralElement[] = [
  ...
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        label: 'Top Trim (above activate star)',
        technicalName: 'PATH_EXTEND_TOP',
        value: 0.12,
        description:
          'How far the helix runs ABOVE the top (authenticate/activate) node before dissolving. Low = the activate star sits right at the top. (admin 2026-06-25: "top of the spiral could be shorter cause I want the authenticate/activate star to be at the top".)',
        control: 'range',
        min: 0,
        max: 2,
        step: 0.05,
  ...
  },
  {
    ...
    params: [
      {
        key: 'colors.initiate',
        label: 'INITIATE Color (bottom)',
        technicalName: 'PHASE_HEX.INITIATE',
        value: '#119a9e',
        description:
      ...
      {
        key: 'colors.integrate',
        label: 'INTEGRATE Color (middle)',
        technicalName: 'PHASE_HEX.INTEGRATE',
        value: '#8cc5d3',
      ...
      {
        key: 'colors.activate',
        label: 'ACTIVATE Color (top)',
        technicalName: 'PHASE_HEX.ACTIVATE',
        value: '#3dbfc4',
