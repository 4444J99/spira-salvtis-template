# Research Thread Map — admin's Curiosity Threads → Spiral Destinations

**Date:** 2026-04-19
**Issue:** GH#32 — Research thread integration

---

## Why This Matters

admin's research threads aren't random — they're the intellectual backbone of the spiral. Each thread enriches a specific part of the architecture. The difference between generic health content and HER health content is these threads. This map connects each thread to its spiral destination so content can be systematically injected.
...
- Node 6 (Emotional Terrain) — alchemy as emotional processing framework
- Node 7 (Nervous System) — transformation through regulation
- Node 8 (Mental Clarity) — distillation metaphor for mental clarity
...
**Spiral injection points:**
- Node 12 (Income Systems) — locked, but content ready
...
**Key findings:**
- Dopamine-driven (achievement, stimulation) vs oxytocin-driven (connection, safety) behavior
- Nervous system regulation as prerequisite for sustainable energy
- Parasympathetic activation through intentional practices

**Spiral injection points:**
- Node 7 (Nervous System) — locked, but this is the core content
- Node 3 (Regulate) — regulation as shifting from dopamine-dominant to balanced

**Editorial note:** Dopamine/oxytocin neuroscience is well-established. Keep with accurate framing. Don't oversimplify the neurochemistry.

### 7. Past Lives + Hunched Back → OUT OF SCOPE

**Source files:** `concepts/hunched-back-and-past-lives.md`

**Spiral injection points:** None. This is personal spiritual exploration, not site content.

**Editorial note:** REMOVE per editorial dispositions.

### 8. Ancient Calendars + Astrology → Deferred (#30)

**Source files:** `business/astrology-social-media-strategy.md`, various time-astro/ files

**Key findings:**
- Mayan calendar cycles and human design
- Astrology-based content scheduling (posting by planetary transit)
- Cycle syncing for women's health content

**Spiral injection points:**
- Deferred to issue #30 (Astrology integration layer)
- If implemented: would inform social content calendar timing

**Editorial note:** Astrology is admin's personal practice. If used, frame as "timing strategy" not "cosmic truth." Cycle syncing has emerging menstrual health evidence.

---

## Citation Backing by Thread
...
8. **Astrology** (Thread 8) — deferred to #30.
