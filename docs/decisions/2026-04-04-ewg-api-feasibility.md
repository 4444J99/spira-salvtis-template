...
**admin's "graceful degradation" note applies:** If real data integration proves too heavy, the static dataset + a CTA ("Can't find your ZIP? Schedule a free water consultation") covers 80% of the US population.
