# Plan: Write admin System Report

## Target File
`/Users/4jp/Workspace/organvm/sovereign-systems--spiral-template/docs/admin-system-report-2026-04-22.md`
...
**Homepage (/)** — Opens with a dramatic 3D interactive spiral. 13 glowing orbs trace a helix path through four phases: Elevate, Align, Unlock, and Gateway. Each orb spins, orbits, and pulses with floating particles. Visitors can drag to rotate the whole scene. Click any orb to visit that node's page. Below the spiral: a quiz call-to-action ("What are you here for?"), the four phases of sovereignty explained, a video placeholder, and a final CTA.
...
**Node Pages (/nodes/1 through /nodes/12)** — Each of the 13 spiral nodes has its own page with content drawn from your original materials. Node 4 (Non Negotiable) has the health tells, gateway metric, and inflammation content. Node 5 (Gateway) links to the gateway funnel.
...
Your original messages said the spiral is the main attraction and gateway is a "mini version." The first build had it backwards — gateway was the hero, the spiral was decoration. We caught this during the atomization process on April 17 and immediately wrote a corrective plan.

The pivot:
- **Before:** Homepage was a pass-through to the gateway page. Every CTA said "Begin with Gateway." The spiral was a 30-line section sandwiched in the middle.
- **After:** The spiral IS the homepage. Gateway lives at its own URL as a focused funnel. The quiz captures leads before routing. Each of the 13 nodes has its own page.
...
1. **Connect the custom domain** (hub-example.com) — takes 5 minutes, makes the site real
