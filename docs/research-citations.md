...
- **Logos** — data and mechanism (specific findings, numbers, pathways)
- **Pathos** — lived experience bridge (connect the science to what people feel)

**Compliance note:** FTC requires that health-related marketing claims be truthful, not misleading, and backed by competent and reliable scientific evidence. Use language like "studies suggest," "research indicates," "has been shown in clinical trials to" — never "cures," "treats," or "guarantees."

---

## General — Molecular Hydrogen as Selective Antioxidant

**Core claim:** H2 selectively neutralizes the most harmful free radicals without disrupting beneficial oxidative processes.
...
- https://pmc.ncbi.nlm.nih.gov/articles/PMC11795818/
...
**Claims to back:** Gut inflammation, microbiome disruption, hormone cascade effects, H2 as gut support.
...
- https://www.sciencedirect.com/science/article/pii/S1756464621000098
- https://www.nature.com/articles/emm2017246
- https://www.sciencedirect.com/science/article/pii/S1570180825001551
...
| Study | Finding | Journal | Year |
|-------|---------|---------|------|
| Chuai et al. (2012, cited in Ge 2017) | H2-saturated solution attenuated male germ cell loss and protected spermatogenesis in radiation-exposed mice with no adverse side effects | (Cited in *Oncotarget* review) | 2012 |
...
**PMC links:**
- https://pmc.ncbi.nlm.nih.gov/articles/PMC5731988/
- https://pmc.ncbi.nlm.nih.gov/articles/PMC4026229/
- https://pubmed.ncbi.nlm.nih.gov/35128448/
...
| Case report: "H2 therapy in SAH with RA and newly-diagnosed SLE" | Improved immune markers including Tr1 cells, Breg cells, TIM3 on Tc cells in patient with RA + SLE | *Front Immunol* | 2024 |

**PMC links:**
- https://pmc.ncbi.nlm.nih.gov/articles/PMC3563451/
- https://www.sciencedirect.com/science/article/pii/S1567576914002124
- https://pmc.ncbi.nlm.nih.gov/articles/PMC5095341/
- https://pmc.ncbi.nlm.nih.gov/articles/PMC3788323/
- https://pmc.ncbi.nlm.nih.gov/articles/PMC11535933/

**This is the strongest evidence branch.** Actual RCTs with specific numbers. Use these numbers.
...
- https://pmc.ncbi.nlm.nih.gov/articles/PMC11046232/
- https://pmc.ncbi.nlm.nih.gov/articles/PMC12076047/
- https://pmc.ncbi.nlm.nih.gov/articles/PMC11509640/

**Key selling point:** H2 is NOT on the WADA Prohibited List. Safe for competitive athletes.

---

## Branch: Cancer Support

**Claims to back:** H2 as safe adjunct (not treatment), reduces side effects of chemo/radiation, quality of life improvement.

| Study | Finding | Journal | Year |
|-------|---------|---------|------|
| Wan et al. "Systematic review of H2 therapy in cancer management" | 27 studies reviewed: H2 amplifies effectiveness of radiation/chemotherapy while alleviating adverse effects without interfering with primary treatment. All studies confirmed safety | *Biomedicines* | 2023 |
| Yang et al. "Molecular hydrogen therapy: review on clinical studies and outcomes" | Comprehensive clinical review: safety confirmed across all administration methods in all studies tested | *Molecules* | 2023 |
| Li et al. "Prospects of molecular hydrogen in cancer prevention and treatment" | H2 induces anti-proliferative, pro-apoptotic, anti-tumoral effects; potential as preventive and therapeutic agent | *Biomed Pharmacother* | 2024 |
| Chen et al. "Clinical efficacy of hydrogen therapy on acute radiation enteritis in cervical cancer" | H2 inhalation significantly alleviated inflammation and symptoms of radiation enteritis during concurrent chemoradiation; no adverse events; did not compromise antitumor outcomes | *Curr Med Res Opin* | 2025 |
| One clinical study (58 patients, advanced NSCLC) | H2 inhalation 4-5h/day for 5 months: relieved pulmonary symptoms, stabilized liver/lung metastases at 1 year, lengthened survival | (Cited in systematic review) | — |

**PMC links:**
- https://pmc.ncbi.nlm.nih.gov/articles/PMC10152878/
- https://pmc.ncbi.nlm.nih.gov/articles/PMC10707987/
- https://pmc.ncbi.nlm.nih.gov/articles/PMC10982102/
- https://www.sciencedirect.com/science/article/pii/S2452109425001666

**CRITICAL TONE NOTE:** This branch uses `tone: soft`. Claims must be presented as supportive, not curative. Language: "research suggests H2 may help support the body during treatment" — NEVER "H2 treats cancer." The systematic review explicitly positions H2 as ADJUNCT therapy.
...
## Hormonal Balance / Stress (Cross-Branch)

**Claims to back:** H2 affects stress hormones, nervous system regulation.
...
- https://pmc.ncbi.nlm.nih.gov/articles/PMC10964576/
...
3. **Cite the authority** (ethos): "In a randomized, double-blind, placebo-controlled trial published in the International Journal of Immunopharmacology..."
4. **Return to the person** (pathos): "This isn't about a miracle molecule. It's about giving your body what it needs at the cellular level to do what it already knows how to do."

**Formatting on the site:** Citations should appear as subtle footnotes or a "Research" expandable section — not inline academic citations that break the emotional flow. The branch pages are conversion tools, not journal articles. The research backs the claims; it doesn't replace the storytelling.
